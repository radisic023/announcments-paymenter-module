        ...
        try {
            return [
                [
                    'name' => 'notice',
                    'type' => 'placeholder',
                    'label' => 'You can use this extension to display announcements on the client area. To create a new announcement, go to Announcements.',
                ],
            ];
        } catch (\Exception $e) {
            return [
                [
                    'name' => 'notice',
                    'type' => 'placeholder',
                    'label' => 'You can use this extension to display announcements on the client area. You\'ll need to enable this extension above to get started.',
                ],
            ];
        }
    }
