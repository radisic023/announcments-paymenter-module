        ...
        return $form
            ->schema([
                ...
                Forms\Components\FileUpload::make('image')
                    ...
                    ->placeholder('Upload an image for the announcement'),
                Forms\Components\Toggle::make('show_image_only_homepage')
                    ->label('Show Image Only on Homepage')
                    ->helperText('If enabled, the image will only be shown on the homepage and not on the announcement details page')
                    ->default(false),
